...
export const ENEMY_HEAD_TO_DIRECTION = {
    [ELEMENT.ENEMY_HEAD_DOWN]: COMMANDS.DOWN,
    [ELEMENT.ENEMY_HEAD_LEFT] : COMMANDS.LEFT,
    [ELEMENT.ENEMY_HEAD_RIGHT]: COMMANDS.RIGHT,
    [ELEMENT.ENEMY_HEAD_UP]: COMMANDS.UP
};
...
export const ENEMY_NORMAL_HEAD = [
    ELEMENT.ENEMY_HEAD_DOWN,
    ELEMENT.ENEMY_HEAD_LEFT,
    ELEMENT.ENEMY_HEAD_RIGHT,
    ELEMENT.ENEMY_HEAD_UP
